...
=======
            ...
            MO(1),      KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_PGDN,    KC_APP,     KC_H,           KC_J,       KC_K,       KC_L,           KC_SCLN,    KC_QUOT, 
            KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_GRV,     KC_DEL,     KC_N,           KC_M,       KC_COMM,    KC_DOT,         KC_SLSH,    KC_RSFT, 
>>>>>>> 2351ed404a (Initial commit wth new keymap)
...
<<<<<<< HEAD
            KC_TRNS,    UG_VALU,    UG_VALD,    UG_SPDU,    UG_SPDD,    KC_TRNS,    UG_NEXT,    KC_TRNS,    LALT(KC_LEFT),  KC_HOME,    KC_END,     LALT(KC_RGHT),  KC_TRNS,    KC_TRNS,
            KC_TRNS,    KC_CAPS,    UG_HUEU,    UG_HUED,    KC_TRNS,    KC_TRNS,    UG_PREV,   KC_TRNS,    KC_LEFT,        KC_DOWN,    KC_UP,      KC_RGHT,        KC_TRNS,    KC_TRNS,
            KC_TRNS,    KC_TRNS,    UG_SATU,    UG_SATD,    KC_TRNS,    KC_TRNS,    UG_TOGG,    KC_INS,     KC_TRNS,        KC_TRNS,    KC_TRNS,    KC_TRNS,        KC_TRNS,    CW_TOGG,
